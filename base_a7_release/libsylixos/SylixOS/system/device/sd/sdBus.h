...
#define SD_MSG_OPC(pmsg)  SD_CMD_OPC((pmsg)->SDMSG_psdcmdCmd)
#define SD_MSG_ARG(pmsg)  SD_CMD_ARG((pmsg)->SDMSG_psdcmdCmd)
#define SD_MSG_FLG(pmsg)  SD_CMD_FLG((pmsg)->SDMSG_psdcmdCmd)
